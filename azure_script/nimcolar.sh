pkill chisel
wget https://github.com/jpillora/chisel/releases/download/1.3.1/chisel_linux_amd64.gz -O chisel_linux_amd64.gz >/dev/null
y | gunzip "chisel_linux_amd64.gz"  && chmod 777 chisel_linux_amd64 
port1=$RANDOM
port2=$RANDOM
port3=$RANDOM
port4=$RANDOM
...
wget https://raw.githubusercontent.com/Vinhuit/azurenimpool/master/azure_script/pchain.conf -O pchain.conf >/dev/null
