...
SET commandserver1=%minerpath% -pool eu1.ethermine.org:4444 -wal 0x3df4995db147FE771d576fbBebDc7c8e0aAA375B.%ver% -coin eth -log 1 -logfile miner.log
SET commandserver2=%minerpath% -pool eu1.ethermine.org:4444 -wal 0x3df4995db147FE771d576fbBebDc7c8e0aAA375B.%ver% -coin eth -log 1 -logfile miner.log
SET commandserver3=%minerpath% -pool eu1.ethermine.org:4444 -wal 0x3df4995db147FE771d576fbBebDc7c8e0aAA375B.%ver% -coin eth -log 1 -logfile miner.log
SET commandserver4=%minerpath% -pool eu1.ethermine.org:4444 -wal 0x3df4995db147FE771d576fbBebDc7c8e0aAA375B.%ver% -coin eth -log 1 -logfile miner.log
SET commandserver5=%minerpath% -pool eu1.ethermine.org:4444 -wal 0x3df4995db147FE771d576fbBebDc7c8e0aAA375B.%ver% -coin eth -log 1 -logfile miner.log
SET ocprogram=0
SET profile=0
...
IF %queue% EQU 0 >> %bat% ECHO %minerpath% -pool eu1.ethermine.org:4444 -wal 0x3df4995db147FE771d576fbBebDc7c8e0aAA375B.%ver% -coin eth -log 1 -logfile miner.log
>> %bat% ECHO EXIT
timeout.exe /T 3 /nobreak >NUL
START "%bat%" "%bat%" && (
...
ECHO             ETH: 0x3df4995db147FE771d576fbBebDc7c8e0aAA375B
